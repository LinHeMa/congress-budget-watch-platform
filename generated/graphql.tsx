...
export type GetBudgetQuery = { __typename?: 'Query', budget?: { __typename?: 'Budget', id: string, type?: string | null, year?: number | null, projectName?: string | null, projectDescription?: string | null, budgetAmount?: number | null, lastYearSettlement?: number | null, majorCategory?: string | null, mediumCategory?: string | null, minorCategory?: string | null, budgetUrl?: string | null, description?: string | null, government?: { __typename?: 'Government', id: string } | null } | null };

export type GetMeetingsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMeetingsQuery = { __typename?: 'Query', meetingsCount?: number | null, meetings?: Array<{ __typename?: 'Meeting', id: string, type?: string | null, location?: string | null, meetingDate?: any | null, meetingRecordUrl?: string | null, description?: string | null }> | null };
...
export type GetMeetingQuery = { __typename?: 'Query', meeting?: { __typename?: 'Meeting', id: string, type?: string | null, location?: string | null, meetingDate?: any | null, meetingRecordUrl?: string | null, description?: string | null, committee?: { __typename?: 'Committee', id: string } | null } | null };

export type GetProposalsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProposalsQuery = { __typename?: 'Query', proposalsCount?: number | null, proposals?: Array<{ __typename?: 'Proposal', id: string, proposalTypes?: string | null, result?: string | null, reductionAmount?: number | null, freezeAmount?: number | null, unfreezeStatus?: string | null, description?: string | null }> | null };
...
export type GetProposalQuery = { __typename?: 'Query', proposal?: { __typename?: 'Proposal', id: string, proposalTypes?: string | null, result?: string | null, reductionAmount?: number | null, freezeAmount?: number | null, unfreezeStatus?: string | null, budgetImageUrl?: string | null, description?: string | null, meetingsCount?: number | null, proposersCount?: number | null, coSignersCount?: number | null, government?: { __typename?: 'Government', id: string } | null, budget?: { __typename?: 'Budget', id: string, projectName?: string | null } | null } | null };
...
export function useGetMeetingsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetMeetingsQuery, GetMeetingsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetMeetingsQuery, GetMeetingsQueryVariables>(GetMeetingsDocument, options);
        }
...
export type GetMeetingsSuspenseQueryHookResult = ReturnType<typeof useGetMeetingsSuspenseQuery>;
...
/**
 * __useGetMeetingQuery__
 *
 * To run a query within a React component, call `useGetMeetingQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetMeetingQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetMeetingQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetMeetingQuery(baseOptions: Apollo.QueryHookOptions<GetMeetingQuery, GetMeetingQueryVariables> & ({ variables: GetMeetingQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetMeetingQuery, GetMeetingQueryVariables>(GetMeetingDocument, options);
      }
export function useGetMeetingLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetMeetingQuery, GetMeetingQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetMeetingQuery, GetMeetingQueryVariables>(GetMeetingDocument, options);
        }
export function useGetMeetingSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetMeetingQuery, GetMeetingQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetMeetingQuery, GetMeetingQueryVariables>(GetMeetingDocument, options);
        }
export type GetMeetingQueryHookResult = ReturnType<typeof useGetMeetingQuery>;
export type GetMeetingLazyQueryHookResult = ReturnType<typeof useGetMeetingLazyQuery>;
export type GetMeetingSuspenseQueryHookResult = ReturnType<typeof useGetMeetingSuspenseQuery>;
export type GetMeetingQueryResult = Apollo.QueryResult<GetMeetingQuery, GetMeetingQueryVariables>;
